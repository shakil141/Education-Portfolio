...
(function (root, factory) {
    ...
    Ssi_upload.prototype.init = function (element) {
        ...
        var $preloader = $('<div id="ssi-preloader" class="ssi-button success ssi-hidden" >' +
            '<div id="ssi-up_loading" class="ssi-btnIn"></div></div>');
        ...
        this.$element.append($('<div class="ssi-buttonWrapper">').append($chooseBtn, $abortBtn, $uploadBtn, $clearBtn, $preloader));
        var $uploadBox;
            ...
            if (thisS.options.preview) {
                var getTemplate = function (content) {
                    return '<table class="ssi-imgToUploadTable ssi-pending">' +
                        ...
                        '<tr><td><button data-delete="' + index + '" class=" ssi-button error ssi-removeBtn"><span class="trash10 trash"><i class="fas fa-trash"></i></span></button></td></tr>' +
                ...
                if (fileType[0] == 'image') {
                    ...
                    fileReader.onload = function () {
                        setTimeout(function () {
                            $('#ssi-preloader').addClass('ssi-preloader-show');
                        }, 10);
                        setTimeout(function () {
                            $('#ssi-preloader').removeClass('ssi-preloader-show');
    ...
    $.fn.ssi_uploader = function (opts) {
        ...
        options.allowed = options.allowed || ['jpg', 'jpeg', 'png', 'pdf'];
